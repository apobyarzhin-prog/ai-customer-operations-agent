...
type Ticket = { id: number; customer: string; initials: string; subject: string; preview: string; time: string; status: 'open' | 'pending' | 'escalated'; channel: string; order: string; email: string; total: string }
